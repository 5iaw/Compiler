...
public class ExpandIdentifier extends Token{
    ...
    public static String [] keywords = {"program", "begin", "int", "if", "else_if", "else", "print_line", "end", "while", "display", "break", "integer", "for"}; // added new keywords
...
//        String [] keywords = {"program", "begin", "int", "if", "else_if", "else", "print_line", "end", "while", "display", "break", "integer", "for"}; // added new keywords

...
public class FSM {
    ...
    public static int opStates(int currentState, String input) {
        switch (currentState) {
            case 0:
                if (input.equals("=") || input.equals("+") || input.equals("*") || input.equals("<") || input .equals("(") || input.equals(")") || input.equals(",") || input.equals(";") || input.equals("==") || input.equals("++") ) {
                    return 1;
                } else {
                    return -1; // not ops?
                }
